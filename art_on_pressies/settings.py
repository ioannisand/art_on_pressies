"""
Django settings for art_on_pressies project.
...
ROOT_URLCONF = 'art_on_pressies.urls'
...
WSGI_APPLICATION = 'art_on_pressies.wsgi.application'
...
# Greek pages fall back to the English value when a translation is blank.
...
DEFAULT_FROM_EMAIL = os.environ.get('EMAIL_HOST_USER', 'noreply@art-on-pressies.fly.dev')
